由于公司最近准备推出一款MID电脑，自己想做一款传感器相关的应用内置MID，所以花了一下午时间看了下源码学习了下。其实源码中传感器内容并不多！但是却是相当强大（我阅读的是Android2.2的源码，以2.2为标准），最近推出的2.3源码还没来得及下，据说2.3的传感器也有些改动，但是不大，更多的是方便游戏开发者。
